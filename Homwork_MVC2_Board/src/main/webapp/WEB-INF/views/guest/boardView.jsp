        ...
        <div class="col-9 pt-3">
            ...
            <div class="row">
                <div class="col text-right mb-4">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="location.href='/member/boardEditor?idx=${dto.idx}';">>수정하기</button>
                    <button type="button" class="btn btn-success" onclick="location.href='/member/delete?idx=${dto.idx}';">삭제하기</button>
