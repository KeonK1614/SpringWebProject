...
@Data
public class EleMap {
	private String sbwy_stn_name;//sbwy_stn_name 지하철명
	...
	private String node_cd;//node_cd 노드 코드 0- 일반, 1-지하철 출입구, 2- 버스정류장, 3- 지하보도 출입구
	private String sgg_nm;//sgg_nm 시군구이름
	private String x_wgs84; //좌표
	private String y_wgs84; //좌표
