...
import com.project.springboot.dao.FileUtil;
...
public class inquiryBoardController
{
	...
	public String inquiryBoard(HttpServletRequest request, Model model)
	{
	  ...
	  model.addAttribute("searchField", searchField); // 목록 하단에 출력할 페이지 번호
	  model.addAttribute("searchWord", searchWord); // 목록 하단에 출력할 페이지 번호
      ...
      model.addAttribute("totalPage", totalPage); // 전체 페이지 갯수
